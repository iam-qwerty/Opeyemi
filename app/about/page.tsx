        ...
        <section className="py-16 md:py-24 bg-muted">
          <div className="container-custom">
            ...
            <StaggeredContainer className="grid md:grid-cols-5 gap-8" staggerDelay={150}>
              <div className="stagger-item bg-background rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-all">
              ...
              <div className="stagger-item bg-background rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-all">
                ...
                <h3 className="text-xl font-bold mb-2">Kindness</h3>
                <p className="text-muted-foreground">
            ...
            <div className="space-y-12">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <AnimationWrapper animation="fade-in-right" className="space-y-4">
                  ...
                  <h3 className="text-2xl font-bold">Driving Climate Action & Sustainability</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <AnimationWrapper animation="fade-in-left" className="space-y-4 order-2 lg:order-1">
                  ...
                  <h3 className="text-2xl font-bold">Empowering the Next Generation</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <AnimationWrapper animation="fade-in-right" className="space-y-4">
                  ...
                  <h3 className="text-2xl font-bold">Shaping Policies that Work for Everyone</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <AnimationWrapper animation="fade-in-left" className="space-y-4 order-2 lg:order-1">
                  ...
                  <h3 className="text-2xl font-bold">Building Sustainable & Inclusive Communities</h3>
                  <p className="text-muted-foreground">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <AnimationWrapper animation="fade-in-right" className="space-y-4">
                  ...
                  <h3 className="text-2xl font-bold">Strengthening Nonprofits for Greater Impact</h3>
                  <p className="text-muted-foreground">
        ...
        <section className="py-16 md:py-24 bg-muted">
          <div className="container-custom">
            ...
            <StaggeredContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" staggerDelay={200}>
              <div className="stagger-item bg-background rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all">
              ...
              <div className="stagger-item bg-background rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all">
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center p-4 bg-olive/10 rounded-lg">
              ...
              <div className="stagger-item bg-background rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all">
                <div className="p-6">
                  ...
                  <div className="aspect-video relative bg-olive/10 rounded-lg">
                    <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="stagger-item bg-background rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all">
                <div className="p-6">
                  ...
                  <div className="p-4 border rounded-lg hover:bg-olive/5 transition-colors cursor-pointer">
